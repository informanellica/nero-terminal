...
- ソースコードドキュメント: <https://informanellica.github.io/nero-terminal/src/>
- 更新履歴: <https://github.com/informanellica/nero-terminal/releases>
...
- `docs/` — 公式サイト (GitHub Pages から配信)
- `docs/src/` — API リファレンス (日本語 / 英語)

## サポート・お問い合わせ

サイトの誤植、リンク切れ、アプリの不具合、機能要望などは
<support@informanellica.com> までお知らせください。
